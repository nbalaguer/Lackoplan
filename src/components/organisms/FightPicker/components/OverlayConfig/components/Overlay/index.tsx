...
function Overlay(props: {
  ...
  return (
    <div
      ref={ref}
      className="relative aspect-video outline outline-2 focus:outline-4 outline-slate-600 transition-[outline-width] duration-100"
      tabIndex={0}
    >
      {!!src && (
        <img src={src} alt="" className="w-full h-full absolute top-0 left-0" />
      )}
    </div>
  )
}
