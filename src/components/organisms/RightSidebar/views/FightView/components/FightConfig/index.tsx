  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-3 p-3">
      ...
      <ButtonGroup className="self-start" label="Difficulty">
        <ButtonGroup.Button text="NM" value="normal" {...register("difficulty")} />
        <ButtonGroup.Button text="HC" value="heroic" {...register("difficulty")} />
        <ButtonGroup.Button text="MM" value="mythic" {...register("difficulty")} />
      </ButtonGroup>
